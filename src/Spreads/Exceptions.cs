...
namespace Spreads
{
    ...
    /// </summary>
    /// <remarks>
    /// It is easy to recover from this exception using the cursor MoveTo method and CurrentKey/NewKey properties
    /// of this exception. E.g. MoveTo(ex.CurrentKey, Lookup.GT) in a catch block is equivalent to ignoring
    /// the exception and continuing to MoveNextAsync.
    /// To replay values that could have been altered by an out-of-order data point, one could use MoveTo(ex.NewKey, Lookup.EQ).
