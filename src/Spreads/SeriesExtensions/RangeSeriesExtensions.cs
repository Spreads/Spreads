...
namespace Spreads
{
    ...
    public static partial class Series
    {
        ...
        public static RangeSeries<TKey, TValue, ICursor<TKey, TValue>> Range<TKey, TValue>(
        ...
        public static RangeSeries<TKey, TValue, ICursor<TKey, TValue>> After<TKey, TValue>(
            this ISeries<TKey, TValue> series,
            TKey startKey, bool startInclusive = true)
        {
            return new RangeSeries<TKey, TValue, ICursor<TKey, TValue>>(series,
        ...
        public static RangeSeries<TKey, TValue, ICursor<TKey, TValue>> Before<TKey, TValue>(
            this ISeries<TKey, TValue> series,
            TKey endKey, bool endInclusive = true)
        {
            return new RangeSeries<TKey, TValue, ICursor<TKey, TValue>>(series,
