...
namespace Spreads
{
    public static partial class Series
    {
        ...
        {
            var cursor = new SMA<TKey, TValue, TCursor>(series.GetContainerCursor(), width, allowIncomplete);
        ...
        public static Series<TKey, TValue, SMA<TKey, TValue, Cursor<TKey, TValue>>>
            SMA<TKey, TValue>(this ISeries<TKey, TValue> series, int width = 1, bool allowIncomplete = false)
        {
            var cursor = new SMA<TKey, TValue, Cursor<TKey, TValue>>(series.GetSpecializedCursor(), width, allowIncomplete);
            return cursor.Source;
        }
        ...
        {
            var cursor = new SMA<TKey, TValue, TCursor>(series.GetEnumerator(), width, allowIncomplete);
            return cursor.Source;
        }
