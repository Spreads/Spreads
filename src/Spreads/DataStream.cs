...
namespace Spreads
{
    ...
    public readonly struct DataStream<T, TSeries, TCursor> : IDataStream<T>
        where TSeries : ISeries<ulong, Timestamped<T>, TCursor>
        where TCursor : ICursor<ulong, Timestamped<T>, TCursor>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IAsyncEnumerator<KeyValuePair<ulong, Timestamped<T>>> GetAsyncEnumerator(CancellationToken ct = default)
        {
            return _impl.GetAsyncEnumerator();
        }

        System.Collections.Generic.IAsyncEnumerator<KeyValuePair<ulong, Timestamped<T>>> System.Collections.Generic.IAsyncEnumerable<KeyValuePair<ulong, Timestamped<T>>>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
    ...
    public readonly struct DataStream<T> : ISeries<ulong, Timestamped<T>, DataStreamCursor<T>>
    {
        ...
        AsyncCursor<ulong, Timestamped<T>, DataStreamCursor<T>> ISeries<ulong, Timestamped<T>, DataStreamCursor<T>>.GetAsyncCursor()
        {
            throw new NotImplementedException();
        }

        DataStreamCursor<T> ISeries<ulong, Timestamped<T>, DataStreamCursor<T>>.GetCursor()
        {
            throw new NotImplementedException();
        }
    ...
    public readonly struct DataStreamCursor<T> : ICursor<ulong, Timestamped<T>, DataStreamCursor<T>>
    {
        ...
        DataStreamCursor<T> ICursor<ulong, Timestamped<T>, DataStreamCursor<T>>.Clone()
        {
            throw new NotImplementedException();
        }
