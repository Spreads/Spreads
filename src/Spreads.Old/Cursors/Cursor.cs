...
namespace Spreads
{
    ...
    /// <summary>
    /// Unspecialized cursor wrapper. Wraps <see cref="ICursor{TKey,TValue}"/> as <see cref="ICursor{TKey,TValue,TCursor}"/>.
    /// </summary>
    public struct Cursor<TKey, TValue> : ICursor<TKey, TValue, Cursor<TKey, TValue>>
    {
        ...
        Series<TKey, TValue, Cursor<TKey, TValue>> ICursor<TKey, TValue, Cursor<TKey, TValue>>.Source
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
