...
namespace Spreads
{
    ...
    /// <summary>
    /// A continuous cursor <see cref="ICursor{TKey,TValue,TCursor}"/> that returns a key and a value
    ...
    public struct RepeatWithKey<TKey, TValue, TCursor> :
        ICursor<TKey, (TKey, TValue), RepeatWithKey<TKey, TValue, TCursor>>
    ...
    public struct Repeat<TKey, TValue, TCursor> :
        ICursor<TKey, TValue, Repeat<TKey, TValue, TCursor>>
        where TCursor : ICursor<TKey, TValue, TCursor>
    {
        #region Cursor state
