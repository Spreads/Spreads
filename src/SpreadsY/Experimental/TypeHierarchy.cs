...
namespace SpreadsX.Experimental
{
    ...
    internal class SeriesImpl<K, V> : SeriesImpl<K>, ISeries<K, V, Cursor<K, V>>, ISeries<K, Any, Cursor<K, Any>>
    {
        public Cursor<K, V> GetCursor() => default;

        ICursor<K, V> ISeries<K, V>.GetCursor() => GetCursor();

        ICursor<K, Any> ISeries<K, Any>.GetCursor() => default;
        Cursor<K, Any> ISeries<K, Any, Cursor<K, Any>>.GetCursor() => default;
    }
    ...
    public struct Cursor<K, V> : ICursor<K, V>
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void GetCurrentKeyValue(DataBlock dataBlock, int currentBlockIndex, out K key, out V value)
            {
    ...
    public struct Cursor<R, C, V> : ICursor<R, ISeries<C, V>>, ICursor<R, Series<C, V>>
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void GetCurrentKeyValue(DataBlock dataBlock, int currentBlockIndex, out R key, out Series<C, V> value)
            {
