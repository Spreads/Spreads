...
//
//// TODO could we live without it? E.g. should we store trade_ids or order is enough?
//// TODO do we need Add method?
//
//// SortedMap with duplicate keys. E.g. ticks that could have same msec key for s single instrument
//// Append-only IOrderedMap with all search methods returning the first key among duplicates.
//
//// This is useful for efficient serialization
//
//
///// Mutable sorted IOrderedMap<'K,'V> implementation based on SCG.SortedList<'K,'V>
//[<AllowNullLiteral>]
//[<SerializableAttribute>]
//type SortedDupMap<'K,'V when 'K : comparison>
