...
//    else
//      this.currentPosition <- map.TryFindAt((snd this.currentPosition).Key, Lookup.GT).TryGet()
//      fst this.currentPosition
//  
//  override this.MovePrevious():bool = 
//    if isReset then this.MoveLast()
//    else
//      this.currentPosition <- map.TryFindAt((snd this.currentPosition).Key, Lookup.LT).TryGet()
//      fst this.currentPosition
//
...
//    let (found, tmp) = map.TryFindAt(key, Lookup.EQ).TryGet()
//    if found then
//      value <- tmp.Value
//      true
//    else false
