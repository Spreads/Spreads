...
type SortedChunkedMapGeneric<'K,'V> 
  ...
  member inline private __.FirstUnsafe
  ...
  override this.First
    with [<MethodImplAttribute(MethodImplOptions.AggressiveInlining);RewriteAIL>] get() = 
      readLockIf &this.nextVersion &this.version (not this.isReadOnly) (fun _ -> this.FirstUnsafe)

  member inline private __.LastUnsafe
    with [<MethodImplAttribute(MethodImplOptions.AggressiveInlining);RewriteAIL>] get() = 
  ...
  override this.Last
    with [<MethodImplAttribute(MethodImplOptions.AggressiveInlining);RewriteAIL>] get() = 
      readLockIf &this.nextVersion &this.version (not this.isReadOnly) (fun _ -> this.LastUnsafe )
