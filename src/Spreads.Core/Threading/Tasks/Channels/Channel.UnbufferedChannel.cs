        ...
        private sealed class UnbufferedChannel<T> : IChannel<T> {
            ...
            private ValueTask<T> ReadAsyncCore(CancellationToken cancellationToken) {
                ...
                lock (SyncObj) {
                    ...
                    if (_completion.Task.IsCompleted) {
                        return new ValueTask<T>(TaskEx.FromException<T>(_completion.Task.IsFaulted ? _completion.Task.Exception.InnerException : CreateInvalidCompletionException()));
                    }
            ...
            public Task WriteAsync(T item, CancellationToken cancellationToken) {
                ...
                lock (SyncObj) {
                    ...
                    if (_completion.Task.IsCompleted) {
                        return TaskEx.FromException(CreateInvalidCompletionException());
                    }
