...
namespace Spreads.Threading.Tasks.Channels {
    ...
    public static partial class Channel {
        ...
        public static IAsyncEnumerator<T> GetAsyncEnumerator<T>(
            ...
            return new AsyncEnumerator<T>(channel);
        }
        ...
        private static Exception CreateSingleReaderWriterMisuseException() =>
            new InvalidOperationException("Concurrent operations may not be issued against a single reader/writer channel.").InitializeStackTrace();
        ...
        private sealed class ClosedChannelException : InvalidOperationException {
            public ClosedChannelException() : base("The channel has been closed.") { }
        }
