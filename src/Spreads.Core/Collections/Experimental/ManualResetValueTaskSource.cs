...
namespace Spreads.Collections.Experimental
{
    ...
    //    IAsyncStateMachine // uses existing builder's support for ExecutionContext, optimized awaits, etc.
    //{
    //    private readonly IAsyncNotifier<bool> _first;
    //    private readonly IAsyncNotifier<bool> _second;
    ...
    //    public ReusableWhenAny2(IAsyncNotifier<bool> first, IAsyncNotifier<bool> second)
    //    {
    //        _first = first;
    //        _second = second;
    //        // _vts = new ManualResetValueTaskSourceLogic<bool>(this);
