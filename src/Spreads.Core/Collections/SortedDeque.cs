...
namespace Spreads.Collections
{
    ...
    public class SortedDeque<T> : IEnumerable<T>
    {
        ...
        public T First
        {
            ...
            get
            {
                if (_count == 0)
                {
                    ThrowHelper.ThrowInvalidOperationException("SortedDeque is empty");
                }
        ...
        internal void DoubleCapacity()
        {
            ...
            {
                ThrowHelper.ThrowInvalidOperationException("Capacity cannot be set to a value less than Count");
            }
    ...
    public class SortedDeque<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        /// Create a new instance of SortedDeque with a default comparer.
        /// </summary>
        public SortedDeque() : this(2, new KVPComparer<TKey, TValue>(null, null)) { }
