...
namespace Spreads
{
        ...
        where TCursor : ISpecializedCursor<TKey, TValue, TCursor>
    {
        ...
        public bool MoveAt(TKey key, Lookup direction)
        {
            ...
            var wasAlreadyMoving = State == CursorState.Moving;

            var ck = wasAlreadyMoving ? _cursor.CurrentKey : default(TKey);
            ...
            if (!moved && wasAlreadyMoving && !_cursor.MoveAt(ck, Lookup.EQ))
            {
