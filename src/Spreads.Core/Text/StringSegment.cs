...
namespace Spreads.Text
{
    ...
    public readonly struct StringSegment : IEquatable<StringSegment>, IComparable<StringSegment>
    {
        ...
        public bool Equals(StringSegment other)
        {
            ...
            ref char first = ref Unsafe.AddByteOffset(ref Unsafe.As<Box<char>>(Text)!.Value, TypeHelper.StringOffset + Segment.Start * sizeof(char));
            ref char otherFirst = ref Unsafe.AddByteOffset(ref Unsafe.As<Box<char>>(other.Text)!.Value, TypeHelper.StringOffset + other.Segment.Start * sizeof(char));
        ...
        public static int GetHashCode(string? str, int start, int length)
        {
            ...
            unchecked
            {
                ...
                ref char first = ref Unsafe.AddByteOffset(ref Unsafe.As<Box<char>>(str)!.Value, TypeHelper.StringOffset + start * sizeof(char));
