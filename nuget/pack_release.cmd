...
dotnet pack ..\src\Spreads.Collections\Spreads.Collections.fsproj -c Release -o ..\artifacts -p:AutoSuffix=False

dotnet restore ..\src\Spreads\Spreads.csproj
dotnet pack ..\src\Spreads\Spreads.csproj -c Release -o ..\artifacts -p:AutoSuffix=False
