...
dotnet pack ..\src\Spreads.Core\Spreads.Core.csproj -c RELEASE -o C:\tools\LocalNuget --include-symbols --version-suffix "%build%" 

dotnet restore ..\src\Spreads.Collections\Spreads.Collections.2017.fsproj
dotnet pack ..\src\Spreads.Collections\Spreads.Collections.2017.fsproj -c RELEASE -o C:\tools\LocalNuget --include-symbols --version-suffix "%build%"
rmdir /s /q ..\src\Spreads.Collections\obj

dotnet restore ..\src\Spreads\Spreads.2017.csproj
dotnet pack ..\src\Spreads\Spreads.2017.csproj -c RELEASE -o C:\tools\LocalNuget --include-symbols --version-suffix "%build%"
