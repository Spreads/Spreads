...
//             // Assert.Throws<InvalidOperationException>(() => { c.Move(-10, false); });
//             // Assert.Throws<InvalidOperationException>(() => { c.MoveTo(10, Lookup.EQ); });
...
//             var s = new Series<int, int>(Array.Empty<int>(), Array.Empty<int>());
//             var c = s.GetCursor();
//             Assert.IsFalse(c.MoveTo(1, Lookup.GT));
//             Assert.IsFalse(c.MoveTo(1, Lookup.GE));
//             Assert.IsFalse(c.MoveTo(1, Lookup.EQ));
//             Assert.IsFalse(c.MoveTo(1, Lookup.LE));
//             Assert.IsFalse(c.MoveTo(1, Lookup.LT));
//             c.Dispose();
//             s.Dispose();
//         }
//
...
//         {
//             Assert.Fail("Proper MT tests");
//             var s = new AppendSeries<int, int>();
//             s.Append(1, 1);
//             var c = s.GetCursor();
//             Assert.IsFalse(c.MoveTo(1, Lookup.GT));
//             Assert.IsTrue(c.MoveTo(1, Lookup.GE));
//             Assert.IsTrue(c.MoveTo(1, Lookup.EQ));
//             Assert.IsTrue(c.MoveTo(1, Lookup.LE));
//             Assert.IsFalse(c.MoveTo(1, Lookup.LT));
//             c.Dispose();
//             s.Dispose();
//         }
...
//         // {
//         //     Assert.Fail("Need a proper MT test");
//         //     var s = new AppendSeries<int, int>();
...
//         //
//         //     var c = s.GetCursor();
//         //     Assert.IsTrue(c.MoveTo(searchValue, Lookup.GT));
//         //     Assert.AreEqual(searchValue + 1, c.CurrentValue);
//         //     Assert.AreEqual(searchValue + 1, c.CurrentKey);
//         //
//         //     Assert.IsTrue(c.MoveTo(searchValue, Lookup.GE));
//         //     Assert.IsTrue(c.MoveTo(searchValue, Lookup.EQ));
//         //     Assert.IsTrue(c.MoveTo(searchValue, Lookup.LE));
//         //     Assert.IsTrue(c.MoveTo(searchValue, Lookup.LT));
//         //     c.Dispose();
//         //     s.Dispose();
//         // }
//
