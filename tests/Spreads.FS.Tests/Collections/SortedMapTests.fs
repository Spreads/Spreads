...
//    [<Test>]
//    member this.``IImmutableSeries reverse``() =
//
//        let mutable watch = Stopwatch.StartNew();
//        let hsm:IImmutableSeries<int,int> = SortedMap<int, int>() :> IImmutableSeries<int,int>
//        let lim = 5120
//        for i = 0 to lim  do
//            (hsm :?> IMutableSeries<int,int>).Add(i,i)
//            //sm.[i] <- sm.Add()
//        
//        watch.Stop()
...
//
//        watch <- Stopwatch.StartNew();
//        let mutable hsm:IImmutableSeries<int,int> = SortedMap<int, int>() :> IImmutableSeries<int,int>
//        let lim = 5120
//        for i = 0 to lim  do
//            hsm <- hsm.Add(i,i)
//        
